      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-center md:text-left mb-6 md:mb-0">
            <h2 className="text-xl font-bold mb-2">Notsolittle</h2>
        ...
        <div className="border-t border-gray-700 mt-6 pt-4 text-center">
          <p className="text-gray-500">
            &copy; {new Date().getFullYear()} Notsolittle. All rights reserved. | Designed by <a href="https://yourportfolio.com" className="text-blue-400 hover:underline">An Amazing Human</a>
          </p>
        </div>
      </div>
    </footer>
